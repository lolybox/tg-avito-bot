...
При запуске на Windows может возникнуть ошибка `WinError 121` (SSL certificate issue). Это связано с антивирусами, которые сканируют HTTPS трафик.

**Решение:**
1. Отключите SSL-сканирование в вашем антивирусе (Kaspersky, ESET, Dr.Web и др.)
2. Или используйте Docker: `docker-compose up`
3. Или разверните проект на Linux-сервере (Render, Railway)
